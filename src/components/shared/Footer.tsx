  ...
  return (
    <footer className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 border-t ">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        {/* Logo + About */}
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">🛍️ ShopHub</h2>
          <p className="text-sm">
            Your one-stop destination for the latest tech, gadgets, and premium products.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/dashboard/user" className="hover:underline">My Dashboard</Link></li>
          </ul>
        </div>

        {/* Contact Info */}
        <div>
          <h3 className="text-lg font-semibold mb-3 text-gray-800 dark:text-white">Contact</h3>
          <ul className="space-y-2 text-sm">
