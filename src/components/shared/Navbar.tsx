...
//                       <Image src="/images/bglogo.png" alt="Logo" fill className="object-contain rounded" sizes="40px" />
//                     </div>
//                     Moshiur Tamim LLC
//                   </SheetTitle>
//                 </SheetHeader>
    ...
    <header className="bg-white shadow-sm border-b sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link href="/" className="flex items-center gap-3">
              {/* Horizontal logo - responsive sizing for different devices */}
              <div className="h-10 w-auto sm:h-12 flex-shrink-0">
                <Image
                  src="/images/updateLogo.png"
